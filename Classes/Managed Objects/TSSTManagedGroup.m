...
+ (NSArray*)archiveTypes
{
	...
	dispatch_once(&onceToken, ^{
		...
		extensions = @[@"com.rarlab.rar-archive", @"cx.c3.cbr-archive",
					   ...
					   @"io.github.hephaex.8views.cbt", @"public.tar-archive",
					   @"com.yacreader.yacreader.cbr", @"com.yacreader.yacreader.cbz",
					   @"io.github.hephaex.8views.cbz-archive", @"io.github.hephaex.8views.cbr-archive",
					   @"io.github.hephaex.8views.cb7-archive", @"io.github.hephaex.8views.cbt-archive"];
	});
...
/**  Called when 8views encounters a password protected
...
- (void)archiveNeedsPassword:(XADArchive *)archive
{
	...
	password = [(EightViewsAppDelegate*)[NSApp delegate] passwordForArchiveWithPath: self.path];
	archive.password = password;
